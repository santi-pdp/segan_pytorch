...
#SAVE_PATH="/veu4/usuaris26/spascual/GSEGAN_liteGEnhancement_RWD-newPASE_nomalign_compressedG_hinge_nopow_zhypercond_skiphypercond"
SAVE_PATH="/veu4/usuaris26/spascual/GSEGAN_liteGEnhancement_RWD-newPASE_nomalign_compressedG_hinge_nopow_zhypercond_skiphypercond_GEMA"
...
python -W ignore -u train_gsegan.py --save_path $SAVE_PATH \
	...
	--gema --ema_decay 0.8 --ema_start 0 --cache
